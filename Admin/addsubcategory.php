                    ...
                    <div class="signup-form w-75 border m-auto p-3 bg-secondary">
                        <form method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control" name="t1" placeholder="Subcategory name"
                                    required="required">
                            </div>
                            <div class=" form-group">
                            ...
                            <div class="form-group">
                                <input type="file" class="form-control" name="t3" placeholder="Upload Image"
                                    required="required">
                            </div>
                            <div class="form-group">
                                <textarea class="form-control" name="t4" placeholder="Details"
