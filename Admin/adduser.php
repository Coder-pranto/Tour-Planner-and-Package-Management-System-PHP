...
if(isset($_POST["sbmt"]))
{
    ...
    if($_POST["password"] == $_POST["confirmpassword"]){
        $s="insert into users values('" . $_POST["name"] ."','" . $_POST["password"] . "','". $_POST["t1"] . "')";
        mysqli_query($conn,$s);
        mysqli_close($conn);
    ...
    <div class=" container">
        <div class="row">
            ...
            <div class="col-8 border-left border-primary text-center">
                ...
                <div class="mt-5 mb-3 ">
                    <div class="w-50 border m-auto bg-secondary shadow p-3 mb-5 rounded">
                        <form method="POST">
                            ...
                            <div class=" form-group">
                                <button type="submit" value="LOGIN" name="sbmt"
                                    class="btn btn-success btn-lg btn-block"> Log In
                                </button>
                            </div>
