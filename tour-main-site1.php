    ...
    <div class="row ">
      ...
      <nav class="nav flex-column bg-dark  text-white box h-100">
        <div class="d-block h4" style="background:rgba(14, 13, 13, 0.868) !important">
            <h3 class="p-2">Destination</h3>
          </div>
          <ul class="list-unstyled text-white box h5">
             <p class="pb-2 pl-2">SYLHET</p>
             <li class="pb-3"><a href="./tour_subxm_transport.php" class="p-2">Connectivity</a></li>
             <li class="active pb-3" >
                  <a href="#homeSubmenu" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle p-2 ">Tourist Spot</a>
                     
                  <ul class="collapse list-unstyled" id="homeSubmenu">
                      <div class="mx-3">
                        <li>
                            <a href="./tour_subxm.php" class="p-2">Sylhet</a>
                        </li>
                        <li >
                            <a href="#" class="p-2" >Jaflong</a>
                        </li>
                        <li>
                            <a href="./tour_subx1.php" class="p-2">Sreemongol</a>
                        </li>
                        <li>
                            <a href="#" class="p-2">Bichanakandi</a>
                        </li>
                        <li>
                            <a href="#" class="p-2">Ratar Gul</a>
                        </li>
                      </div>
                  </ul>
              </li>
      ...
      <div class="col-10 ">
        <div class="content">
          ...
          <header class="row p-4">
            <h2 class="col-12 text-center ">Welcome to Sylhet</h2>
          ...
          <div class="about">
            <p class="h5 text-justify">
              <span class="fs-1 ">Sylhet (Bengali: সিলেট)</span> is a metropolitan
          ...
          <div class="container weather">
            <div class="row my-4 ">
              ...
              <div class="col-6 ">
                <div class=" d-flex justify-content-center mt-5"><a target="_blank" href="https://www.booked.net/weather/sylhet-58041"><img src="https://w.bookcdn.com/weather/picture/7_58041_1_1_137AE9_320_ffffff_333333_08488D_1_ffffff_333333_0_6.png?scode=124&domid=w209&anc_id=67682" alt="" width="450px" height="350px" /></a></div>
              </div>
            </div>
          </div>
