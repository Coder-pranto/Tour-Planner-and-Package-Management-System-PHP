...
<body>
            ...
            <div class="tbl2 col-10 mt-3">
                <div>
                    <table cellpadding="0px" cellspacing="0" width="1000px">
                        <tr>
                            <td class="font-weight-bold h3 pb-0 ">Subcategories</td>
                        </tr>
                        <tr>
                            <td class="paraText" width="900px">
                                ...
                                <table cellpadding="0" cellspacing="0" width="900px">
                                    ...
                                    $cat_id = $_GET["catid"];
                                    $s2 = "select * from subcategory where Catid='$cat_id'";
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <table border="0" width="100px" bordercolor="#FF6666">
                                                ...
                                                <tr>
                                                    <td align="center"
                                                        style="background-color:#60B0E6; font-family:Lucida Calligraphy; color:black">
                                                        <?php echo $data[1]; ?> </td>
                                                </tr>
                                                <tr>
                                                    <td class="image"><img src="images/new/<?php echo $data[3]; ?>"
                                                            width="250px" height="200px" /></td>
                                                </tr><br /><br />
                                                <tr>
                                                    <td align="center"
                                                        style="background-color:#60B0E6; font-family:Lucida Calligraphy">
                                                        <a href="package.php?subcatid=<?php echo $data[0]; ?>">
    ...
    <footer class="bg-dark text-center text-white h-50">
