    ...
    <div class="row ">
      ...
      <div class="col-10 ">
        <div class="content">
          ...
          <h2 class="text-center"><span class="border border-warning  p-2 mb-2">Best Hotels in Sreemongol, You are Invited</span></h2>
      <br />
      <hr />
      <hr class="w-75 pb-2">
                 <div>
                    <nav class="nav justify-content-center mt-3">
                        <ul class="pagination pg-blue">
                            ...
                            <li class="page-item active"><a class="page-link mr-3" href="#">Luxury</a></li>
                            <li class="page-item"><a class="page-link mr-3" href="#">Budget</a></li>
...
<div class=" container d-flex flex-row justify-content-center">
  ...
  <?php include "./component/hotelLuxury.php" ?>
  
  <?php include "./component/hotelBudget.php" ?>
